...
- Must-cover subtopics from the SERP research are covered.
- The search intent is covered completely without padding — shorter and complete beats longer and repetitive.
- Reader questions and objections surfaced in research are addressed.
- FAQ, if present, answers distinct questions the body didn't; if absent, nothing needed it.
...
- Title: descriptive, concise, distinctive; ~45–65 characters when practical, clarity never sacrificed to hit a count.
- Meta description: accurate, compelling; ~140–165 characters when practical, accuracy over length.
- Slug: short, lowercase, hyphenated, keyword-bearing.
- Primary and related terminology present naturally where relevant.
- Schema recommendation appropriate and accurate to visible content (never default FAQ schema).
- Image concepts described; alt text drafted only where image content is known; no keyword-stuffed alt text.
- Front-matter complete: title options, meta, slug, keyword, intent, unique_value, schema recommendation, word count, and reviewer/review_date where applicable.
