...
updated: 2026-08-01
source: interview | parsed_content_packet | both
---
...
`source: parsed_content_packet` marks a profile seeded from `cursive-agent-2-content-parse`, which already extracts brand signals, tone, offers, and proof points from a live site. If a packet exists for the domain, ingest it rather than re-deriving what another agent already produced.
